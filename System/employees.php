								...
								?>
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="employee-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
										    ...
										    <?php 
										    if ($empavatar == null) {
									        print '<center><img class="img-circle autofit11" src="images/default.jpg" alt="image"  /></center>';
										    }else{
										    echo '<center><img class="img-circle autofit11" alt="image" src="data:image/jpeg;base64,'.base64_encode($empavatar).'"/></center>';	
										    }
										    ?>

				...
				<div class="container">
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
							...
							<?php 
							if ($complogo == null) {
							print '<center><img class="autofit31" alt="image"  src="images/blank.png"/></center>';
							}else{
							echo '<center><img class="autofit31" alt="image"  src="data:image/jpeg;base64,'.base64_encode($complogo).'"/></center>';	
							}
							?>

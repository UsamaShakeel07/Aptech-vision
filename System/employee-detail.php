							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="employee-detail-wrapper">
									...
									<div class="employee-detail-header text-center">
										...
										<?php 
										if ($empavatar == null) {
										print '<center><img class="img-circle autofit211" src="images/default.jpg"  alt="image"  /></center>';
										}else{
										echo '<center><img class="img-circle autofit211" alt="image" src="data:image/jpeg;base64,'.base64_encode($empavatar).'"/></center>';	
										}
										?>
										</div>

...
<head>
	...
	<title>Individual - Professional Qualifications</title>
...
background: #313431 !important;
border-bottom: 1px solid #992020 !important;
}
</style>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="image">	
										...
										<p class="user-role" style="color: #ddd !important;"><?php echo "$mytitle"; ?></p>
										
									</div>
									
									<div class="admin-user-action text-center">
									
									<a href="resume.php" style="background-color: black; padding: 10px 20px 10px 20px;">View Resume</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-9">
							...
							<a href="./"><img src="../images/logos.png" alt="Logo" /></a>
                                        ...
                                        <h5 class="footer-title">About Individual</h5>
                                        <p>Individual is a job portal, online job management system developed by Usama Shakeel & Ahzam Alam for Aptech Vision 2023.</p>
                        ...
                        <div class="col-sm-12 col-md-3 mt-30-sm">
                            ...
                            <h5 class="footer-title">Individual Contact</h5>
                            
                            <p>Address : Aptech, North Nazimabad Branch</p>
                            <p>Email : <a href="mailto:futurevisiontech@gmail.com">futurevisiontech@gmail.com</a></p>
                            <p>Phone : <a href="tel:+92 313-206-6038">+92 313-206-6038</a></p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4">
                            ...
                            <p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Future Vision Tech</p>
                        ...
                        <div class="col-sm-4 col-md-4">
                            ...
                            <ul class="bottom-footer-menu">
                                <li><a >Developed by Usama Shakeel | Ahzam Alam</a></li>
                            </ul>
